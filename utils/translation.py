    ...
    translations = {
        ...
        "en": {
            ...
            "agent_system_prompt": (
                ...
                "- When using run_pyqgis_code for inspection or verification tasks, use print() to output your results — "
                "all printed output is captured and returned to you in the 'print_output' field so you can analyze it. "
                "Never print inside a loop over features; instead accumulate results and print a summary at the end. "
            ...
            "agent_intent_user": (
                ...
                "- \"analyse\" : spatial calculations, advanced statistics, quality check, frequency tables, value distribution, percentiles, median, quartiles, correlation between fields, group-by statistics (stats per category)\n"
